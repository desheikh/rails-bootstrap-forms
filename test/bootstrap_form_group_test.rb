...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test 'form_group renders the "error" class and message corrrectly when object is invalid' do
    ...
    expected = %{<div class="form-group has-danger"><p class="form-control-static">Bar</p><span class="invalid-feedback">can&#39;t be blank, is too short (minimum is 5 characters)</span></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "adds offset for form_group without label" do
    ...
    expected = %{<div class="form-group row"><div class="col-sm-10 offset-sm-2"><input class="btn btn-secondary" name="commit" type="submit" value="Update User" /></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "adds offset for form_group without label but specific label_col" do
    ...
    expected = %{<div class="form-group row"><div class="col-sm-8 offset-sm-5"><input class="btn btn-secondary" name="commit" type="submit" value="Update User" /></div></div>}
    assert_equivalent_xml expected, output
  end
